...
internal class Tetrion {
    ...
    // bool obpf_tetrion_is_connected(struct ObpfTetrion const* tetrion);
    [DllImport(Common.DllPath, EntryPoint = "obpf_tetrion_is_connected")]
    public static extern bool IsConnected(IntPtr tetrion);
